 ...
 * {@link BillingHandler}. The main application implements the callbacks
...
public abstract class BillingObserver {
    ...
    private static final String TAG = "jfabrix101-PurchaseObserver";
     ...
     * {@link BillingHandler#purchaseResponse(Context, PurchaseState,
     * String, String, long)}.
