...
import jfabrix101.security.Base64;
...
public class BillingSecurity {
    ...
    private static final String TAG = "jfabrix101-Security";
    ...
    public static final byte[] secretKey = new byte[] { 41, -90, -116, -41, 66,
		-53, 121, -110, -127, -96, -88, -22, 127, 115, 1, 73, 57, 110, 48,
		-116 };
    ...
    public static class VerifiedPurchase {
        ...
        public String toString() {
        	...
        	sb.append("purchaseState:").append(purchaseState)
        		...
        		.append(", purchaseTime:").append(new Date(purchaseTime))
        		.append(", developerPayload:").append(developerPayload);
        	return sb.toString();
        }
    }
    ...
    public static void registerPublicKey(Context context, String publicKey) {
    	SharedPreferences pref = context.getSharedPreferences("billingPK", 0);
    	AESObfuscator obfuscator = AESObfuscator.getDefaultObfuscator(context);
    	String obuscatedKey = obfuscator.obfuscate(publicKey);
    	pref.edit().putString("pk", obuscatedKey).commit();
    }
}
