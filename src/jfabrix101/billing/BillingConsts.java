...
public class BillingConsts {
	...
	public static final String BILLING_ITEM_AndroidTestPurchased = "android.test.purchased";
	public static final String BILLING_ITEM_AndroidTestCanceled = "android.test.canceled";
	public static final String BILLING_ITEM_AndroidTestRefunded = "android.test.refunded";
	public static final String BILLING_ITEM_AndroidTestItemUnavailable = "android.test.item_unavailable";
    ...
    public static final String ACTION_CONFIRM_NOTIFICATION =  "-billingAction.CONFIRM_NOTIFICATION";
    public static final String ACTION_GET_PURCHASE_INFORMATION = "-billingAction.GET_PURCHASE_INFORMATION";
    public static final String ACTION_RESTORE_TRANSACTIONS = "-billingAction.RESTORE_TRANSACTIONS";

    // Intent actions that we receive in the BillingReceiver from Market.
    // These are defined by Market and cannot be changed.
    public static final String VENDING_ACTION_NOTIFY = "com.android.vending.billing.IN_APP_NOTIFY";
    public static final String VENDING_ACTION_RESPONSE_CODE = "com.android.vending.billing.RESPONSE_CODE";
    public static final String VENDING_ACTION_PURCHASE_STATE_CHANGED = "com.android.vending.billing.PURCHASE_STATE_CHANGED";
